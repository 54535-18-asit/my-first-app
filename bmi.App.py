...
st.write("กรอกข้อมูลน้ำหนักและส่วนสูงของคุณ เพื่อเช็คสุภาพเบื้องต้น")
...
File "/mount/src/my-first-app/bmi.App.py", line 8
  if st.button("คำนวค่า BMI"):
...
st.divider()
st.write("นายอซิตะ อิกำเหนิด เลขที่ 18 ม.4/11")
